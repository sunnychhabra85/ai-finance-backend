  ...
  */
  ...
  export interface UploadDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
    **/
    createManyAndReturn<T extends UploadCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, UploadCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$UploadPayload<ExtArgs>, T, 'createManyAndReturn'>>
  ...
  interface UploadFieldRefs {
    ...
    readonly fileHash: FieldRef<"Upload", 'String'>
  ...
  export type UploadWhereInput = {
    ...
    fileHash?: StringFilter<"Upload"> | string
  ...
  export type UploadScalarWhereWithAggregatesInput = {
    ...
    fileHash?: StringWithAggregatesFilter<"Upload"> | string
